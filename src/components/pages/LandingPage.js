    ...
    <div className="land-icons">
      <div className="land-sub-flex">
        ...
        <div className="landing-head-div">
          ...
          <span className="google-span">Google</span>
          <span className="form-span"> Forms</span>
        </div>
      </div>
      <div className="g-head-div">
        <h1 className="g-head-h1">Get insights quickly, with Google Forms</h1>
        <p className="g-para-p">
      ...
      <div className="g-btn-div">
        ...
        <Link to="/createform" className="g-btn2-form">
          Go To Forms
        </Link>
      </div>
      <div className="g-btn-div">
      ...
      <div className="customerGrid">
        <div>
          <h1 className="customer-h1">Send polished surveys and forms</h1>
          <p className="srevey-p">
